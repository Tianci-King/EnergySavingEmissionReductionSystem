...
<!--       数据分析-->
<!--      </span>-->
<!--      <a-menu-item :class="['menuItem']" key="1">-->
<!--        <icon-apps />-->
<!--        碳排放数据统计-->
<!--      </a-menu-item>-->
...
<!--        3S-DEA-->
<!--      </a-menu-item>-->
<!--      <a-menu-item :class="['menuItem']" key="3">-->
<!--        <icon-apps />-->
<!--        碳排放数据预测-->
<!--      </a-menu-item>-->
<!--    </a-menu-item-group>-->
...
<template>
  ...
  >
    <a-menu-item-group class="menuItemGroup" style="overflow: hidden">
      ...
      <a-menu-item  class="menuItem" key="1"><icon-apps />碳排放数据统计</a-menu-item>
      <a-menu-item  class="menuItem" key="2"><icon-apps />3S-DEA</a-menu-item>
      <a-menu-item  class="menuItem" key="3"><icon-apps />碳排放数据预测</a-menu-item>
    </a-menu-item-group>
  </a-menu>
</template>
...
const selectKey = useAnalysisStore.selectKey;
